 ...
 * the {@link com.example.base.widget.MultiStateView.ViewState} accordingly
...
public class MultiStateView extends FrameLayout {
    ...
    private void animateLayoutChange(@Nullable final View previousView) {
        ...
        ObjectAnimator anim = ObjectAnimator.ofFloat(previousView,
                "alpha", 1.0f, 0.0f).setDuration(250L);
