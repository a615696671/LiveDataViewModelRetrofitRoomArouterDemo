...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private int decorationPadding=0;
    ...
    public DividerItemDecoration setDecorationPadding(int decorationPadding) {
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if(child!=null){
                ...
                if (mDrawable != null) {
                    ...
                    mDrawable.setBounds(x+ decorationPadding, y, width, height);
